...
function Sidebar() {
    const menu = [
        { title: "Overview", id: 1, route: "/overview", icon: HomeIcon },
        { title: "Orders", id: 2, route: "/orders", icon: ShoppingBagIcon },
        { title: "Restaurant Partners", id: 6, route: "/restaurants", icon: UserGroupIcon },
        { title: "Customers", id: 5, route: "/customers", icon: UserCircleIcon },
        { title: "Delivery", id: 4, route: "/delivery", icon: TruckIcon },
        { title: "User Management", id: 10, route: "/users", icon: UsersIcon },
                ...
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    ...
                    <ul class="space-y-2 font-medium">
                        {menu.map((el) => {
                            return (
                                <li>
                                    <Link href={el.route} id={el.id} class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
